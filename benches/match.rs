...
fn tinystr4_match(c: &mut Criterion) {
    ...
    c.bench_function("match str 4", |b| b.iter(|| {
        for s in STRINGS.iter() {
            black_box(match_str(s));
        }
    }));

    c.bench_function("match tiny 4", |b| b.iter(|| {
...
fn tinystr8_match(c: &mut Criterion) {
    ...
    c.bench_function("match str 8", |b| b.iter(|| {
        for s in STRINGS.iter() {
            black_box(match_str(s));
        }
    }));

    c.bench_function("match tiny 8", |b| b.iter(|| {
        for s in TINYSTRS.iter() {
            black_box(match_tiny(*s));
        }
    }));
...
fn tinystr16_match(c: &mut Criterion) {
    ...
    c.bench_function("match str 16", |b| b.iter(|| {
        for s in STRINGS.iter() {
            black_box(match_str(s));
        }
    }));

    c.bench_function("match tiny 16", |b| b.iter(|| {
        for s in TINYSTRS.iter() {
            black_box(match_tiny(*s));
        }
    }));
